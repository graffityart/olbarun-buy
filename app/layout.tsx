...
export const metadata: Metadata = {
  metadataBase:new URL('https://pumasy.co.kr'),
  title,
  description,
  alternates:{canonical:'/'},
  keywords:['폐컴퓨터 매입','중고컴퓨터 매입','컴퓨터 매입','폐컴퓨터 수거','컴퓨터 수거','컴퓨터 폐기','서버 매입','중고서버 매입','서버 폐기','전산장비 매입','전산장비 폐기','사무실 컴퓨터 매입','기업 컴퓨터 매입','대량 컴퓨터 매입','불용자산 매입','불용 전산장비 매입','네트워크 장비 매입','통신장비 매입','하드디스크 파기','HDD 천공'],
  openGraph:{title,description,url:'https://pumasy.co.kr',siteName:'올바른매입',locale:'ko_KR',type:'website'},
  twitter:{card:'summary_large_image',title,description},
  robots:{index:true,follow:true,googleBot:{index:true,follow:true}},
};

const organizationSchema={
  '@context':'https://schema.org','@type':'Organization',name:'올바른매입',url:'https://pumasy.co.kr',
  description:'전국 폐컴퓨터·중고컴퓨터·서버·전산장비·네트워크 장비 및 기업 불용 IT자산 매입과 저장장치 데이터 파기 상담',
  areaServed:{'@type':'Country',name:'대한민국'},
  knowsAbout:['폐컴퓨터 매입','중고컴퓨터 매입','서버 매입','전산장비 매입','네트워크 장비 매입','HDD 데이터 파기']
};

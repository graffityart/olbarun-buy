...
function dateText(value:string|Date){return new Intl.DateTimeFormat('ko-KR',{timeZone:'Asia/Seoul',year:'2-digit',month:'2-digit',day:'2-digit'}).format(new Date(value)).replace(/\. /g,'.').replace('.','-').replace('.','-').replace(/\.$/,'');}
